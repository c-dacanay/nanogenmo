...
INTERESTS = {
    'sports': {
        ...
        'verb': ["watch #topic replays on Youtube", "watch the game at a bar"]
    },
    'outdoors': {
        'hobbies': ["camping", "hiking", "climbing"],
        'location': ["the state park", "a hiking trail"],
        'verb': ["get out of the city", "go on a #topic trip"]
    },
    'food-drink': {
        'hobbies': ["beer", "wine", "coffee"],
        'location': ["a winery", "a restaurant that just opened", "a #class-list class"],
        'verb': ["try a new recipe", "make fancy cocktails"]
    },
    'performing-arts': {
        'hobbies': ["stand-up comedy", "magic tricks", "theatre"],
        'location': ["a play", "#person's next show", "an improv show"],
        'verb': ["go LARPing", "take an acting class"]
    },
     'literature': {
        'hobbies': ["reading", "fiction-writing", "poetry"],
        'location': ["#pronoun's favorite bookstore", "the library", "a release party"],
